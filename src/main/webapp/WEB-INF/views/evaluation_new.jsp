...
<div class="row">
    <div class="col-md-6 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Neue Auswertung<small> Daten im Formular eingeben</small></h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <br>
                <form:form action="persist" method="POST" modelAttribute="evaluation" cssClass="form-horizontal form-label-left input_mask" >
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">gewählte Umfrage</label>
                        <form:input path="survey" value="survey.title"/>
                    </div>
