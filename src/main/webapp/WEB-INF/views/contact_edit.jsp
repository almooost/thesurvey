...
<div class="row">
    <div class="col-md-6 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Kontakt<small> bearbeiten</small></h2>
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <form:input path="givenname" cssClass="form-control col-md-7 col-xs-12" value="${givenname}"  />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <form:input path="name" cssClass="form-control col-md-7 col-xs-12" value="${name}" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <form:input path="email" cssClass="form-control col-md-7 col-xs-12" value="${email}" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <form:input path="department" cssClass="form-control col-md-7 col-xs-12" value="${department}"  />
                    </div>
                </div>
